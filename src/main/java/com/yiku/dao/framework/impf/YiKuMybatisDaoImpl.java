package com.yiku.dao.framework.impf;

import com.yiku.dao.framework.Page;
...
@Component
@Scope("prototype")
public class YiKuMybatisDaoImpl<T, PK extends Serializable> extends YiKuBaseMybatisDAO<T, PK> implements YiKuDAO<T,PK> {
    ...
    public <R> List<R> executeListMethodInsidePage(Object param, String statement, Page page, String pageStatement,
                                                   Class<R> r) {
        return executeListMethodInsidePageImpl(param, bulidStatements(statement), page, bulidStatements(pageStatement), r);
    }
